...
/**
 * Edit modal for a single DeliveryTransportSet, shared by every view that lists
 * transport sets as events (calendar, planner, ...). Views open it by dispatching
 * the `open-transport-set-modal` browser event instead of calling it directly,
 * so it can live once on the page regardless of how many views embed it.
 */
class TransportSetEditModal extends Component
{
    ...
    public function save(): void
    {
        ...
        $this->dispatch('transport-set-saved');
    }

    public function render()
    {
        return view('livewire.modals.transport-set-edit-modal');
    }
}
