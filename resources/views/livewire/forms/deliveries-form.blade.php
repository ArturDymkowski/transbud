        ...
        <x-form.section title="{{ __('deliveries.goods.goods') }}">
            <div class="flex flex-col gap-4">
                @foreach($goodsData as $index => $good)
                    ...
                    <div wire:key="good-row-{{ $index }}" class="grid grid-cols-1 gap-x-6 gap-y-5 sm:grid-cols-3 p-4 rounded-xl border border-gray-100 dark:border-gray-800">
                        <div class="col-span-1">
                        ...
                        <div class="col-span-1">
                            <div class="flex items-end gap-2">
                                <div class="flex-1" x-data="quantityInput(@entangle('goodsData.'.$index.'.quantity'))">
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        {{ __('deliveries.goods.quantity') }} <x-form.input.required-star/>
                                    </label>
                                    <input type="text"
                                           inputmode="decimal"
                                           name="goodsData.{{ $index }}.quantity"
                                           :value="display"
                                           ...
                                           @class([
                                               ...
                                               'border-gray-300 dark:border-gray-700' => !$errors->has("goodsData.{$index}.quantity"),
                                               'border-red-300 dark:border-red-700' => $errors->has("goodsData.{$index}.quantity"),
                                           ])/>
                                    @error("goodsData.{$index}.quantity")
