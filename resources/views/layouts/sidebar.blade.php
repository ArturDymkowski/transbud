                    ...
                    <div>
                        ...
                        <ul class="flex flex-col gap-1">
                            @foreach ($menuGroup['items'] as $itemIndex => $item)
                                <li>
                                    @if (isset($item['subItems']))
                                        <!-- Menu Group Header (collapsible, no icon) -->
                                        <button @click="toggleSubmenu({{ $groupIndex }}, {{ $itemIndex }})"
                                            type="button"
                                            class="flex w-full items-center gap-2 px-3 py-2 text-xs font-semibold uppercase text-gray-400 dark:text-gray-500"
                                            :class="!$store.sidebar.isExpanded && !$store.sidebar.isHovered ?
                                                'xl:justify-center' : 'xl:justify-between'">
                                                    ...
                                                    <li>
                                                        <a href="{{ $subItem['path'] }}" class="menu-dropdown-item"
                                                            ...
                                                            @if (isset($subItem['icon']))
                                                                <x-dynamic-component :component="$subItem['icon']" class="w-5 h-5" />
                                                            @endif
                                                            {{ $subItem['name'] }}
