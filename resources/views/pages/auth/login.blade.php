                    ...
                    <div>
                        ...
                        <div>
                            <form method="post" action="{{ route('login.store') }}">
                                @csrf
                                <div class="space-y-5">
                                    <x-form.input.text-input type="text" name="email" required="true" placeholder="info@gmail.com" label="{{ __('auth.email') }}" value="adminnn@transbud.com" />
                                    <x-form.input.text-input type="password" name="password" required="true" placeholder="{{ __('auth.enter_password') }}" label="{{ __('auth.password') }}" value="adminnn" />
